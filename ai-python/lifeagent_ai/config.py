...
# LA-007 习惯目标类型
HABIT_TARGET_NEW = "NEW"
HABIT_TARGET_PENDING_DRAFT = "PENDING_DRAFT"
HABIT_TARGET_RECENT_HABIT = "RECENT_HABIT"
HABIT_TARGET_RECENT_EXECUTION = "RECENT_EXECUTION"

# LA-007 习惯操作类型
HABIT_ACTION_UPSERT_DRAFT = "UPSERT_DRAFT"
HABIT_ACTION_CONFIRM_DRAFT = "CONFIRM_DRAFT"
HABIT_ACTION_ACK = "ACK"
HABIT_ACTION_COMPLETE = "COMPLETE"
HABIT_ACTION_PAUSE = "PAUSE"
HABIT_ACTION_RESUME = "RESUME"
HABIT_ACTION_CANCEL = "CANCEL"

VALID_HABIT_TARGETS = frozenset({
    HABIT_TARGET_NEW, HABIT_TARGET_PENDING_DRAFT,
    HABIT_TARGET_RECENT_HABIT, HABIT_TARGET_RECENT_EXECUTION,
})
VALID_HABIT_ACTIONS = frozenset({
    HABIT_ACTION_UPSERT_DRAFT, HABIT_ACTION_CONFIRM_DRAFT,
    HABIT_ACTION_ACK, HABIT_ACTION_COMPLETE,
    HABIT_ACTION_PAUSE, HABIT_ACTION_RESUME, HABIT_ACTION_CANCEL,
})
